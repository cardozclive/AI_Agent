...
const basicModel = new ChatFireworks(
    {
        model : "lama-v3p1-70b-instruct"
    }
)

const advanceModel = new ChatMistralAI(
    {
...
// If message count is less than 3 -> CheaperModel, it it exceed 3, then we will need AdvancedModel
